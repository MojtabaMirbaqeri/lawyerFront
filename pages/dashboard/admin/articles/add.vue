<template>
  <div class="article-form-page">
    <div class="page-header mb-6">
      ...
      <p class="text-sm text-gray-500 mt-1">مقاله شما بلافاصله پس از ثبت در سایت نمایش داده می‌شود.</p>
    </div>
      ...
      <div class="card-dashboard-body p-6">
        <form @submit.prevent="onSubmit" class="space-y-6">
          ...
          <div class="flex gap-3">
            ...
            <NuxtLink to="/dashboard/admin/articles" class="btn-secondary">انصراف</NuxtLink>
          </div>
        </form>
      </div>
    </div>
...
async function onSubmit() {
  ...
  if (res.statusCode === 201 || res.statusCode === 200) {
    useToast().add({
      title: "مقاله با موفقیت ثبت شد و در سایت نمایش داده می‌شود.",
      color: "success",
    });
    await navigateTo("/dashboard/admin/articles");
  }
}
</script>
