        ...
        <table class="table-dashboard">
          ...
          <tbody>
            <tr
              ...
              @click="openTicket(ticket)">
              <td>
                <span class="font-mono text-gray-600">#{{ ticket.id }}</span>
              </td>
              <td>
                <span class="font-medium text-gray-900">{{ ticket.ticketTitle }}</span>
              </td>
              <td>
                <div class="flex items-center gap-2">
              ...
              <td>
                <span class="badge" :class="getStatusBadgeClass(ticket.statusVal)">{{
                  ticket.status
                }}</span>
              </td>
              <td>
